...
当月预计提成取三个月前的绩效周期，例如 9 月对应 6 月绩效（5 月 16 日至 6 月 15 日）。仅“拜托了闻学长”账号适用 `(抖音条数 * 54000 + 小红书条数 * 20000) / 2 * 10%`，即每条抖音 2700 元、小红书 1000 元。其他账号统计发布量但暂不计提成。账号默认按项目名称前缀识别，也可在项目编辑中更正。未完成或未来日期的视频不计入，实际金额以公司结算为准。平台信息使用现有项目 JSON 同步与备份，无需迁移数据库。
