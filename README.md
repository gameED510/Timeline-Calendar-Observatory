...
- 主站：https://xxltl.xyz/
- EdgeOne 备用网址：https://tl-calendar-planner-global-aq0pqjrq.edgeone.dev/

## 发布绩效

“绩效”页按上月 16 日（含）到所选月份 15 日（含）统计已完成发布的视频，本月 16 日起归入下月。按平台分别计数，同时显示涉及的项目数。项目编辑中点选抖音、小红书开关，每个平台记一条；日期统一使用项目发布节点日期，不再填写独立日期。未补平台的历史项目单独列出。

当月预计提成取三个月前的自然发布月，例如 10 月结算对应 7 月发布。每个账号可独立设置抖音/小红书报价、收益分成比例和个人提成比例；默认“拜托了闻学长”为抖音 54000 元、小红书 20000 元，再乘 50% 收益分成与 10% 个人提成。账号默认按项目名称关键词识别，也可在项目编辑中指定。

只有明确标记“发布完成”的项目参与统计；完成状态是最终依据，即使发布节点日期晚于今天，也会立即归入该日期对应的绩效周期。未完成项目不计入，未选择平台的完成项目会进入“待补平台”。实际金额以公司结算为准，平台信息随项目同步和备份。

项目名称下方可直接选择发布平台，并标记“赠送项目”。赠送项目仍计入发布数量，但从提成金额及计佣条数中排除；赠送标记与项目一起同步和备份。
