...
function getClientIp(request) {
  return request.headers.get("eo-connecting-ip")
...
export default async function onRequest(context) {
  ...
  const supabaseUrl = String(
    context.env.SUPABASE_URL || FALLBACK_SUPABASE_URL
  ).replace(/\/$/, "");
  const anonKey = context.env.SUPABASE_ANON_KEY || FALLBACK_SUPABASE_ANON_KEY;
